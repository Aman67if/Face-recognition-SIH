...
export function AuthForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#b2f1ff] to-[#c0f3c9] dark:from-[#1a2c2f] dark:to-[#22372a] p-4">
      <motion.div
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Smart Attendance & Student Management System</p>
        </div>
